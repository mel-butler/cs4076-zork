...
namespace RoomDialogue{
    const string lr_n = "   you are facing the north wall of the living room\n"
                        "   glass windows stretch along the wall from ceiling to floor.\n"
    ...
    const string lr_w = "   you are facing the west wall of the living room\n"
                        ...
                        "   the water here is a huge contrast from the raging waters outside\n"
                        "   there is a door next to the waterfall";

    const string b_n="    you are now facing the north wall of the bathroom\n"
                     "    there is a mirror in front of you. when you look at your reflection\n"
                     "    a tired man stares back. your eyebags are far too prominent, and your\n"
                     "    face far too weary. a multitude of bandages and plasters cover your  face andvbody\n"
                     "    would be nice to have something coveer  your face. \n "
    ...
    const string b_s="    you are now facing the south wall of the bathroom\n"
                     "    there is nothing here but the toilet and an open first aid kit-\n"
                     "    oh wait! this is where you left that helmet";
    ...
    const string b_w="    you are now in the bathroom\n"
                     ...
                     "    there is a door in front of you, next to the fluffy white towels";
